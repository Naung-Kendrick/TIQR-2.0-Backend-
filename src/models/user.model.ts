...
const userSchema = new Schema<any, TUserModel, IUserMethods>({
    name: {
        type: String,
...
userSchema.methods.comparePassword = async function (this: any, enterPassword: string) {
    return await bcrypt.compare(enterPassword, this.password);
};

// Exporting both the model and a helper type for documents with methods
export type IUserDocument = Document<unknown, {}, any> & IUser & { lastLoginAt?: Date } & IUserMethods;
