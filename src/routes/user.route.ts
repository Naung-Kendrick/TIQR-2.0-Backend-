...
import { deleteUser, getAllUsers, getCurrentUserInfo, getUserById, login, register, updateUserInfo, updateUserPassword, updateUserPwdByAdmin, updateUserRoleByAdmin, uploadUserAvatar, updateUserStatusByAdmin, heartbeat, getOnlineUsers, updateUserLoginLimit } from "../controllers/user.controller";
...
userRouter.patch('/update-login-limit', isAuthenticated, authorizeRoles([UserRole.ROOT_ADMIN, UserRole.ADMIN]), updateUserLoginLimit);
